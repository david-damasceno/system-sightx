  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {/* File attachment */}
        {message.attachment && (
          <div className={cn("mt-3 p-2 rounded-md flex items-center gap-2", isAI ? "bg-white/10" : "bg-black/10")}>
            {message.attachment.type.startsWith("image/") ? (
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button 
                          size="sm" 
                          variant="ghost" 
                          className={cn("h-6 w-6 p-0 rounded-full", isAI ? "hover:bg-white/20" : "hover:bg-black/20")} 
              ...
              <>
                ...
                <Button 
                  size="sm" 
                  variant="ghost" 
                  className={cn("h-8 w-8 p-0 rounded-full", isAI ? "hover:bg-white/20" : "hover:bg-black/20")} 
                  onClick={() => window.open(message.attachment.url, "_blank")}
                >
