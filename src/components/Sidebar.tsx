...
import { MessageSquare, History, User, LogOut, Menu, X, Plus, ChevronRight, ChevronLeft, Settings, BellRing, HelpCircle, Moon, Sun, Briefcase, BarChart, Bookmark, PanelLeftOpen, PanelLeftClose } from "lucide-react";
