...
const Login = () => {
  ...
  return <div className="w-full max-w-md px-4">
      ...
      <Card className={`glass-panel shadow-xl transition-all duration-700 ${animateElements ? 'opacity-100 transform scale-100' : 'opacity-0 transform scale-95'}`}>
        ...
        <Form {...loginForm}>
          <form onSubmit={loginForm.handleSubmit(onLoginSubmit)}>
            <CardContent className="space-y-4 pb-2">
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input placeholder="nome@exemplo.com" {...field} className={`bg-white/50 dark:bg-black/50 h-11 pl-10 transition-all duration-300 ${field.value ? 'border-sightx-purple' : ''}`} autoComplete="email" />
                      </FormControl>
              ...
              field
                    ...
                    <div className="relative">
                      <FormControl>
                        <Input type={showPassword ? "text" : "password"} {...field} className={`bg-white/50 dark:bg-black/50 h-11 pl-10 pr-10 transition-all duration-300 ${field.value ? 'border-sightx-purple' : ''}`} autoComplete="current-password" />
                      </FormControl>
                      <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                      <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 transform -translate-y-1/2 h-9 w-9" onClick={() => setShowPassword(!showPassword)}>
            ...
            <CardFooter className="flex flex-col gap-4 pt-2">
              <Button type="submit" className="w-full bg-sightx-purple hover:bg-sightx-purple-light h-11 shadow-lg shadow-sightx-purple/20 transition-all hover:shadow-xl hover:shadow-sightx-purple/30" disabled={isLoading}>
                {isLoading ? <>
                    ...
                    <Form {...signupForm}>
                      <form onSubmit={signupForm.handleSubmit(onSignupSubmit)} className="space-y-4 py-4">
                        ...
                        field
                              ...
                              <div className="relative">
                                <FormControl>
                                  <Input placeholder="nome@exemplo.com" {...field} className="pl-10" />
                                </FormControl>
                                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                              </div>
                              <FormMessage />
                        ...
                        field
                              ...
                              <div className="relative">
                                <FormControl>
                                  <Input type={showSignupPassword ? "text" : "password"} {...field} className="pl-10 pr-10" />
                                </FormControl>
                                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 w-8" onClick={() => setShowSignupPassword(!showSignupPassword)}>
                        ...
                        field
                              ...
                              <div className="relative">
                                <FormControl>
                                  <Input type={showSignupConfirmPassword ? "text" : "password"} {...field} className="pl-10 pr-10" />
                                </FormControl>
                                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                                <Button type="button" variant="ghost" size="icon" className="absolute right-1 top-1/2 transform -translate-y-1/2 h-8 w-8" onClick={() => setShowSignupConfirmPassword(!showSignupConfirmPassword)}>
                        ...
                        <DialogFooter>
                          <Button type="submit" className="w-full bg-sightx-purple hover:bg-sightx-purple-light" disabled={isLoading}>
                            {isLoading ? <>
                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                                Criando conta...
                              </> : "Criar conta"}
